...
// Server mail user & pass
	 ...
	 * @param port The Port
	 */
	public PruebaMail(String user, String pass, String host, String port) {
		this.user = user;
		this.pass = pass;
	...
	public static void main(String[] args) {
		...
		PruebaMail emailService = new PruebaMail("2dam2curious", "abcd*1234", null, null);
		try {
			emailService.sendMail("2dam2curious@gmail.com", "adriancgs@gmail.com", "Mensaje de prueba", "Correo de vital importancia");
